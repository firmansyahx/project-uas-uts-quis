...
.biodata {
  ...
  <body>
        <h1 class="text-center text-success mt-3">Biodata</h1>
<div class="container">
  <div class="card kartu">
    <div class="row">
      <div class="col-md-4">
      <div class="foto">
        <img src="foto/luffyD.jpg" class="img-thumbnail" alt="" width="150" height="auto">
      </div>
      </div>
          ...
          <tbody>
            <tr>
              <td width="25%" valign="top" class="textt">Nama</td>
                <td width="2%">:</td>
                <td style="color: #00FFFF; font-weight:bold">Firmansyah Rumatiga</td>
            </tr>
          <tr>
